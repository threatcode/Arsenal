...
```console
$ xzcat kali-linux-2024.1-pinebook-arm64.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2024.1-pinebook-arm64.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
