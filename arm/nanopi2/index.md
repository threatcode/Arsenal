...
By default, the Kali Linux NanoPi2 image contains the [**kali-linux-default** metapackage](/docs/general-use/metapackages/) similar to most other platforms. If you wish to install extra tools please refer to our [metapackages page](/docs/general-use/metapackages/).
...
```console
$ xzcat kali-linux-2024.1-nanopi2-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
